                    ...
                    <ul class="nav flex-column">
                        <li class="nav-item" style="margin-bottom: 40px;">
                            <div class="row align-items-start">
                                ...
                                <div class="col">
                                    <img src="{{asset("./images/php/php.png")}}" alt="learning-logo" style="height: 45px;">
                                </div>
                            </div>
                        </li>
                        <li class="nav-item">
                        ...
                        <div class="container mt-4">
                            ...
                            <div class="tab-content mt-3">
                                <div class="tab-pane fade show active" id="learning">
                                    ...
                                    @php
                                        $limit_id = $topic->id;
                                        $row = DB::table('php_topics_detail')->where('id_topics', $limit_id)->first();
                                        $rowArray = (array) $row;
                                        if ($row) {
                                            $rows = $row->id;  
                                        } 
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="col-md-7">
                                ...
                                <div class="text-sm" style="margin-bottom: 20px">
                                    <p style="margin-bottom: 5px !important">Sebelum memulai pembelajaran PHP, Anda harus memiliki pengetahuan dasar tentang <b>HTML, CSS, dan JavaScript</b>.</p>
