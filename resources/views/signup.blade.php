...
<body>
    <div class="container" style="margin-top: 50px; width: 500px;">
        ...
        <form action="{{ route('post_signup') }}" method="post" onsubmit="return validateForm()">
            ...
            <select class="form-control" id="teacherName" name="teacher">
                <option value="" disabled selected>Choose a Teacher</option>
                <option value="Yan Watequlis Syaifudin">Yan Watequlis Syaifudin</option>
                <option value="Pramana Yoga Syaputra">Pramana Yoga Syaputra</option>
                <option value="Dwi Puspitasari">Dwi Puspitasari</option>
            </select>
            <center>
            <button class="btn btn-primary" type="submit">Sign Up</button>
            <p style="text-align: center; margin-top: 12px; font-weight: 500">Already have an account? <span style="color: #0079FF;" onclick="window.location.href='/'"><a href="">Sign In</a></p>
        </center>
        </form>
        <script>
